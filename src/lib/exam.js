...
export const EXAM_DATE = new Date(2027, 0, 1);
export const WINDOW1_END = new Date(2027, 0, 1, 0, 0);
export const WINDOW2_START = new Date(2027, 0, 1, 0, 0);
export const WINDOW2_END = new Date(2027, 0, 1, 0, 0);
