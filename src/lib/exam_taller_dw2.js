export const STORAGE_KEY = 'dw2_taller_attempts';
export const DETAIL_KEY = 'dw2_taller_details';
...
export const SYNC_QUEUE_KEY = 'dw2_taller_sync_queue';
export const SAVED_ANSWERS_KEY = 'dw2_taller_saved_answers';
export const HEALTH_CHECK_KEY = 'dw2_taller_last_health_check';
