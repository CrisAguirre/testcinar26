<script lang="ts">
  ...
  const modules = [
    ...
    { hours: '2h', topic: 'Sentencias básicas', objective: 'Entrada, procesamiento y salida de información' },
    { hours: '4h', topic: 'Estructuras condicionales simples', objective: 'Si-entonces, Según-sea para toma de decisiones' },
    { hours: '2h', topic: 'Estructuras condicionales compuestas', objective: 'Si-sino-si para condiciones múltiples' },
    { hours: '2h', topic: 'Operadores', objective: 'Operadores matemáticos y de relación' },
    { hours: '4h', topic: 'Estructuras de ciclos', objective: 'Para, Mientras que, Repetir hasta' },
    { hours: '2h', topic: 'Ciclos anidados', objective: 'Ejecutar ciclos dentro de ciclos' },
    { hours: '2h', topic: 'Arreglos unidimensionales', objective: 'Crear y manipular arreglos para almacenar datos' },
    { hours: '2h', topic: 'Sistema de menú', objective: 'Integrar estructuras secuenciales, condicionales y repetitivas' }
  ];
</script>

<svelte:head>
  <title>Algoritmos — Cinar Sistemas</title>
</svelte:head>
...
<style>
  ...
  .banner-bg {
    position: absolute;
    inset: 0;
    background: linear-gradient(135deg, #10B981, #047857, #064E3B, #047857, #10B981);
