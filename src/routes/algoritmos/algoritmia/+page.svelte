<script lang="ts">
  ...
  async function loadProgress() {
    ...
    try {
      ...
      const tallerGrades = grades.filter((g: any) => g.subject === 'Algoritmos - Taller Algoritmia');
...
<svelte:head>
  <title>Algoritmia - Algoritmos</title>
</svelte:head>

<div class="page">
  <div class="page-header">
    <a href="/algoritmos" class="back-link">← Volver a Algoritmos</a>
    <div class="title-row">
      <h1>Algoritmia</h1>
      {#if !loadingProgress}
    ...
    <p class="page-subtitle">Algoritmos — Fundamentos de lógica y algoritmos</p>
  </div>
  ...
  <section class="taller-card">
    ...
    <a href="/algoritmos/algoritmia/taller" class="btn-primary">
