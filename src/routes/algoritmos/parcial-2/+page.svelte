<script lang="ts">
  import { selectRandomQuestions } from '$lib/data/parcial2_algo';
  ...
  async function loadServerAttempts() {
    ...
    try {
      ...
      const examGrades = all.filter((g: any) => g.subject === 'Algoritmos - Parcial 2');
...
<svelte:head>
  <title>Parcial 2 - Algoritmos</title>
</svelte:head>
  ...
  {:else if finished}
    <div class="finish-screen">
      <div class="finish-card">
        ...
        {/if}
        <p class="finish-info">Has completado el Parcial 2 de Algoritmos.</p>
