<script lang="ts">
  ...
  $effect(() => {
    ...
    if (enrollments && !enrollments.some((e: any) => e.course === 'desarrollo-web-2')) {
      goto('/');
    }
  });

  const links: { href: string | null; icon: string; label: string; disabled?: boolean }[] = [
    { href: '/desarrollo-web-2/parcial-1', icon: '📝', label: 'Parcial 1' },
    { href: '/desarrollo-web-2/parcial-2', icon: '📝', label: 'Parcial 2' },
  ...
  const modules = [
    { hours: '2h', topic: 'Introducción a conceptos avanzados', objective: 'Comprender el manejo avanzado de rutas en Svelte.js' },
    { hours: '2h', topic: 'Profundización en componentes', objective: 'Explorar características avanzadas de componentes' },
    { hours: '2h', topic: 'Propiedades en componentes', objective: 'Aplicar el uso de props para el paso de datos' },
    { hours: '2h', topic: 'Integración de diseño con Bootstrap', objective: 'Integrar componentes de Bootstrap dentro de Svelte.js' },
    { hours: '2h', topic: 'Buenas prácticas en organización', objective: 'Modularizar componentes y mejorar mantenibilidad' },
    { hours: '2h', topic: 'Persistencia de datos', objective: 'Guardar posts en memoria o almacenamiento local' },
    { hours: '2h', topic: 'Interactividad avanzada', objective: 'Crear inputs personalizados y gestionar su comportamiento' },
    { hours: '2h', topic: 'Comunicación entre componentes', objective: 'Usar createEventDispatcher para enviar datos entre componentes' },
    { hours: '2h', topic: 'Reutilización avanzada', objective: 'Implementar slots, slots personalizados y eventos' },
    { hours: '2h', topic: 'Optimización de la aplicación', objective: 'Aplicar el ciclo de vida de los componentes' }
  ];
</script>

<svelte:head>
  <title>Desarrollo Web 2 — Cinar Sistemas</title>
</svelte:head>
  ...
  <div class="banner-inner">
    ...
    <div class="banner-content">
      ...
      <div class="banner-text">
        ...
        <h1 style="font-weight: 700; font-size: 1.55rem;">Desarrollo Web 2</h1>
        <p class="banner-desc">Segundo nivel de Svelte JS - 24 horas. Incluye práctica profesional sobre arquitectura de software y despliegue en la nube.</p>
      </div>
    </div>
...
<style>
  ...
  .banner-bg {
    position: absolute;
    inset: 0;
    background: linear-gradient(135deg, #DC2626, #991B1B, #450A0A, #991B1B, #DC2626);
