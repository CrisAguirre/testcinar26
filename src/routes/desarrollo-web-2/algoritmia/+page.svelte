<script lang="ts">
  ...
  async function loadProgress() {
    ...
    try {
      ...
      const tallerGrades = grades.filter((g: any) => g.subject === 'Desarrollo Web 2 - Taller Algoritmia');
...
<svelte:head>
  <title>Algoritmia - Desarrollo Web 2</title>
</svelte:head>

<div class="page">
  <div class="page-header">
    <a href="/desarrollo-web-2" class="back-link">← Volver a Desarrollo Web 2</a>
    <div class="title-row">
      <h1>Algoritmia</h1>
      {#if !loadingProgress}
    ...
    <p class="page-subtitle">Desarrollo Web 2 — Fundamentos de lógica y algoritmos</p>
  </div>
  ...
  <section class="taller-card">
    ...
    <a href="/desarrollo-web-2/algoritmia/taller" class="btn-primary">
