<script lang="ts">
  ...
  async function loadServerAttempts() {
    ...
    try {
      ...
      const examGrades = all.filter((g: any) => g.subject === 'Desarrollo Web 2 - Parcial 2');
    ...
    for (const entry of queue) {
      ...
      try {
        const res = await gradesApi.submitMine({
          subject: 'Desarrollo Web 2 - Parcial 2',
          score: entry.score,
...
<svelte:head>
  <title>Parcial 2 - Desarrollo Web 2</title>
</svelte:head>
  ...
  {#if !started && !finished}
    <div class="welcome-screen">
      <div class="welcome-card">
        ...
        <h1>Parcial 2 - Desarrollo Web 2</h1>
  ...
  {:else if finished}
    <div class="finish-screen">
      <div class="finish-card">
        ...
        {/if}
        <p class="finish-info">Has completado el Parcial 2 de Desarrollo Web 2.</p>
